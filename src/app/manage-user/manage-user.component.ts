...
export class ManageUserComponent implements OnInit {
  ...
  retrieveTutorialsAdmin(): void {
    this.tutorialService.getAllAdmin().subscribe({
      next: (data) => {
  ...
  retrieveTutorialsHr(): void {
    this.tutorialService.getAllHr().subscribe({
      next: (data) => {
  ...
  deleteEmployee(row: any) {
    this.api.deleteEmployee(row.eid).subscribe((res) => {
  ...
  adminEmployee(row: any) {
    ...
    this.api
      .updateEmployee(this.employeeModelObj, this.employeeModelObj.eid)
      .subscribe((res) => {
        this.toastr.info(
          'Successfully transferred ' + this.employeeModelObj.name + ' to Admin'
        );
        let ref = document.getElementById('cancel');
        ref?.click();
        this.formValue.reset();
  ...
  hrEmployee(row: any) {
    ...
    this.api
      ...
      .subscribe((res) => {
        this.toastr.info(
          'Successfully transferred ' + this.employeeModelObj.name + ' to HR'
        );
        let ref = document.getElementById('cancel');
        ref?.click();
        this.formValue.reset();
  ...
  updateEmployeeDetails() {
    ...
    this.api
      ...
      .subscribe((res) => {
        this.toastr.info(
          this.employeeModelObj.name + ' Details Updated Successfully'
        );
        let ref = document.getElementById('cancel');
        ref?.click();
        this.formValue.reset();
